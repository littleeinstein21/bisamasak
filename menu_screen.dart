      ...
      body: FutureBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            String videoUrl = data!['videoUrl'].toString(); // Assuming there's a 'videoUrl' field in your Firestore
                      ...
                      children: [
                          ...
                          children: [
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color:
                                      const Color.fromARGB(255, 8, 32, 73),
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            width: 370.0,
                            decoration: BoxDecoration(
                              color: const Color.fromARGB(255, 8, 32, 73),
                              borderRadius: BorderRadius.circular(30.0),
                              boxShadow: [
                                BoxShadow(
                                  color: Colors.black.withOpacity(0.3),
